...
\begin{document}
    ...
    \begin{frame}{Что такое дериватив?}
        \begin{tikzpicture}[scale=0.85]  % Масштабирование всей картинки
            ...
            % Волнистые стрелки (кэшфлоу) сверху вниз, втыкаются в ось
            \draw[decorate,decoration={snake, amplitude=0.6mm, segment length=4mm},->,thick,blue] (1,1) -- (1,0);
            \draw[decorate,decoration={snake, amplitude=0.6mm, segment length=4mm},->,thick,blue] (3.5,1) -- (3.5,0);
            \draw[decorate,decoration={snake, amplitude=0.6mm, segment length=4mm},->,thick,blue] (7,1) -- (7,0);
