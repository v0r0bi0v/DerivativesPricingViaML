...
\begin{document}
    ...
    \begin{frame}{Подход с линеаризацией}
        ...
        Построить модель, которая будет кроме цены дериватива предсказывать и свою уверенность в этой цене (подобно тому, как работает uncertainty в Gaussian Process Regressor).
    \end{frame}
