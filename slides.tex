...
\begin{document}
    ...
    \begin{frame}{Что такое дериватив?}
        ...
        \begin{tikzpicture}[scale=0.9]  % Масштабирование всей картинки
            ...
            \draw[decorate,decoration={snake, amplitude=0mm, segment length=3mm, post length=0.5mm},->,thick,blue] (3.5,1) -- (3.5,0);
            \draw[decorate,decoration={snake, amplitude=0.3mm, segment length=6mm, post length=0.5mm},->,thick,blue] (7,1) -- (7,0);
        ...
        Кроме того бывает и такое, что одна из сторон может закончить сделку по некоторым условиям в произвольный момент.
    \end{frame}
