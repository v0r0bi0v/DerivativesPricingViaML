...
\begin{document}
    ...
    \begin{frame}{Что такое дериватив?}
        \begin{tikzpicture}[scale=0.85]  % Масштабирование всей картинки
            ...
            \draw[decorate,decoration={snake, amplitude=0mm, segment length=4mm},->,thick,blue] (1,1) -- (1,0);
            \draw[decorate,decoration={snake, amplitude=0.3mm, segment length=4mm},->,thick,blue] (3.5,1) -- (3.5,0);
